...
INSERT INTO `terrain` (adresse_lat, adresse_long, adresse_voie, date_ajout, description, nom, superficie, utilisateur_id_utilisateur) VALUES ('47.31599472245832','4.973904249086494', 'Chemin de la Combe à la Serpent 21000 Dijon','2021-06-15','Vaste terrain avec une majeur partie dans les collines','Les vertes collines', '125', '4');
INSERT INTO `terrain` (adresse_lat, adresse_long, adresse_voie, date_ajout, description, nom, superficie, utilisateur_id_utilisateur) VALUES ('47.16673788371554','5.247437695570869', 'Les Petites Broisses 21170 Montot','2021-07-06','Terrain à l abandon ayant besoin d ordre','La jungle', '200', '5');
INSERT INTO `terrain` (adresse_lat, adresse_long, adresse_voie, date_ajout, description, nom, superficie, utilisateur_id_utilisateur) VALUES ('47.36337393454189','4.896973895438594', 'Parc n°2, Stand, 21370 Prenois','2021-07-29','Petite prairie qui accueillerait avec plaisir un troupeau pour sa gestion','La prairie chatoyante', '50', '6');
INSERT INTO `terrain` (adresse_lat, adresse_long, adresse_voie, date_ajout, description, nom, superficie, utilisateur_id_utilisateur) VALUES ('47.40019634206459','5.0382444830708595', 'Les Epoisses 21380 Messigny-et-Vantoux','2021-06-15','petit terrain à tondre','Le petit', '25', '4');
...
INSERT INTO `troupeau` (adresse_lat, adresse_long, adresse_voie, date_ajout, date_disponibilite, description, divisibilite, effectif, nom, race_id_race, utilisateur_id_utilisateur) VALUES ('47.334619288733755','5.035309610716516', '16 Rue Antoine Le Moiturier 21000 Dijon','2021-04-04','2021-04-04','Là où elles passent, l herbe ne repoussent plus', true, '500','Les chèvres Attila','10','1');
...
INSERT INTO `troupeau` (adresse_lat, adresse_long, adresse_voie, date_ajout, date_disponibilite, description, divisibilite, effectif, nom, race_id_race, utilisateur_id_utilisateur) VALUES ('47.12003459733698','4.9922804930886455', 'Rue de Citeaux 21700 Agencourt','2021-05-30','2021-05-30','Ces vaches seront discrète et éfficace', false, '50','Les vaches ninjas','4','2');
INSERT INTO `troupeau` (adresse_lat, adresse_long, adresse_voie, date_ajout, date_disponibilite, description, divisibilite, effectif, nom, race_id_race, utilisateur_id_utilisateur) VALUES ('47.21619857417899','5.183992388256473', 'Rue Saint-Éloi 21110 Marliens','2021-06-11','2021-06-15','Ces juments seront un choix idéal pour prairie de grande envergure', false, '20','Les juments grises','3','3');

INSERT INTO `troupeau` VALUES (5,'47.0459016992357','4.796569278383358','La Grande Chatelaine 21200 Beaune','2020-11-10','2020-11-25',NULL,NULL,'Les moumoutes à Robert, cest 40 bêtes avec un coeur gros comme ça, prêtes à manger lherbe de vos terrains pour votre plus grand paisir.',true,40,'Les moumoutes à Robert',1,8);
...
INSERT INTO `troupeau` VALUES (15,'47.68606890424283','4.858126971345889','Chemin Rural des Praulon 21290 Saint-Broing-les-Moines','2020-11-10','2021-01-10',NULL,NULL,'Croyez moi vous allez être surpris davoir de tel bêtes dans votre domaine !',true,15,'Hightland Cattle',10,23);
...
INSERT INTO `troupeau` VALUES (19,'47.02016161637006','4.823760507547958','34 Rue des Écureuils 21200 Beaune','2020-11-10','2021-01-10',NULL,NULL,'Son élégance naturelle et sa docilité font du trait poitevin un cheval très apprécié pour la selle ou pour lattelage.',false,8,'Les Trait Poitevin',15,27);

INSERT INTO `offre` (date_ajout, date_debut, date_fin, description, frequence_intervention, installation_assuree, nom, prix_bete_jour, prix_installation, prix_intervention, prix_km, zone_couverture,conditionAnnulation_id_condition_annulation, troupeau_id_troupeau) VALUES ('2021-04-04', '2021-04-04', '2022-10-29', 'je recherche un terrain pour mon troupeau','2', true,'Offre pour les chèvres Attila','2','1000','20','.5','60','1', '1');
